...
let PlantSchema = new Schema(
    {
        ...
        lat: {type: Float32Array, required: true, max: 20},
        lon: {type: Float32Array, required: true, max: 20},
        plant_desc: {type: String, required: true, max: 300},
        plant_height: {type: Float32Array, required: true, max: 10},
        plant_spread: {type: Float32Array, required: true, max: 10},
        db_pedia_link: {type: String, required: true, max: 300},
